...
class CasecategoryView(
        ModelView):  #MasterDetailView, MultipleView, CompactCRUDMixin
...
class SubcountyView(
    ...
    #add_columns = person_list_columns + ref_columns + contact_columns
    #edit_columns = person_list_columns + ref_columns + contact_columns
    list_columns = ref_columns + ['county']
    #list_widget = ListBlock|ListItem|ListThumbnail|ListWidget (default)
    #page_size = 10
    #related_views =[]
    #formatters_columns = {‘some_date_col’: lambda x: x.isoformat() }
...
# Setup
appbuilder.add_view(
    CountyView(), "Counties", icon="fa-folder-open-o", category="Setup")
appbuilder.add_view(
    SubcountyView(), "Sub Counties", icon="fa-folder-open-o", category="Setup")
appbuilder.add_view(
    ConstituencyView(),
    "Constituencies",
    ...
    category="Setup")
appbuilder.add_view(
    TownView(), "Towns", icon="fa-folder-open-o", category="Setup")
appbuilder.add_view(
    CourtstationView(),
    "Court Stations",
    icon="fa-folder-open-o",
    category="Setup")
appbuilder.add_view(
    CourtView(), "Courts", icon="fa-folder-open-o", category="Setup")
appbuilder.add_view(
    PaymentmethodView(),
    "Payment Methods",
    icon="fa-folder-open-o",
    category="Setup")
appbuilder.add_view(
    LawfirmView(), "Law Firms", icon="fa-folder-open-o", category="Setup")
appbuilder.add_view(
    PolicestationView(),
    "Police Stations",
    icon="fa-folder-open-o",
    category="Setup")
appbuilder.add_view(
    PrisonView(), "Prisons", icon="fa-folder-open-o", category="Setup")
appbuilder.add_view(
    PrisoncellView(), "Prison Cells", icon="fa-folder-open-o", category="Setup")
...
appbuilder.add_view(
    ...
    category="Categories")
appbuilder.add_view(
    GenderView(), "Genders", icon="fa-folder-open-o", category="Categories")
appbuilder.add_view(
    HearingtypeView(),
    "Hearing Types",
    icon="fa-folder-open-o",
...
appbuilder.add_view(
    SecurityrankView(),
    "Prison Security Ranks",
    icon="fa-folder-open-o",
    category="Categories")
appbuilder.add_view(
    TagView(), "Tags", icon="fa-folder-open-o", category="Categories")
appbuilder.add_view(
    DoctemplateView(),
    "Doc Templates",
    icon="fa-folder-open-o",
...
# People
appbuilder.add_view(
    PlaintiffView(), "Plaintiffs", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    DefendantView(), "Defendants", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    WitnesView(), "Witnesses", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    JudicialofficerView(),
    "Judicial Officers",
    icon="fa-folder-open-o",
    category="People")
appbuilder.add_view(
    LawyerView(), "Lawyers", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    PolofficerView(),
    "Police Officers",
    icon="fa-folder-open-o",
    category="People")
appbuilder.add_view(
    ProsecutorView(), "Prosecutors", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    VisitorView(), "Visitors", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    WarderView(), "Warders", icon="fa-folder-open-o", category="People")
appbuilder.add_view(
    SuretyView(), "Sureties", icon="fa-folder-open-o", category="People")
...
appbuilder.add_view(
    ...
    category="Process")
appbuilder.add_view(
    CaseView(), "Cases", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    HearingView(), "Hearings", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    FilingView(), "Filings", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    BailView(), "Bail", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    DocumentView(), "Documents", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    DocarchiveView(),
    "Doc Archives",
    icon="fa-folder-open-o",
...
appbuilder.add_view(
    ...
    category="Process")
appbuilder.add_view(
    PaymentView(), "Payments", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    PrisonerpropertyView(),
    "Prisoner Property",
    icon="fa-folder-open-o",
    category="Process")
appbuilder.add_view(
    RemissionView(), "Remissions", icon="fa-folder-open-o", category="Process")
appbuilder.add_view(
    VisitView(), "Visits", icon="fa-folder-open-o", category="Process")

# Charts & Reports
appbuilder.add_view(
    EventlogView(), "Eventlogs", icon="fa-folder-open-o", category="Reports")
appbuilder.add_view(
    LawyerChartView(),
    'Lawyer Age Chart',
    icon='fa-dashboard',
...
appbuilder.add_view(
    ProsecutorChartView(),
    'Prosecutor Age Chart',
    icon='fa-dashboard',
    category='Reports')
appbuilder.add_view(
    ProsecutorTimeChartView(),
    'Prosecutor Time Chart',
    icon='fa-dashboard',
    category='Reports')

appbuilder.add_view(
    PoliceofficerChartView(),
    'Policeofficer Age Chart',
    icon='fa-dashboard',
    category='Reports')
appbuilder.add_view(
    PoliceofficerTimeChartView(),
    'Policeofficer Time Chart',
    icon='fa-dashboard',
    category='Reports')

appbuilder.add_view(
    JudicialofficerChartView(),
    'Judicialofficer Age Chart',
    icon='fa-dashboard',
    category='Reports')
appbuilder.add_view(
    JudicialofficerTimeChartView(),
    'Judicialofficer Time Chart',
    icon='fa-dashboard',
    category='Reports')
...
appbuilder.add_view(
    ...
    category='Reports')
appbuilder.add_view(
    DefendantTimeChartView(),
    'Defendant Time Chart',
    icon='fa-dashboard',
    category='Reports')
...
appbuilder.add_view(
    DisciplineChartView(),
    'Discipline Age Chart',
    icon='fa-dashboard',
    category='Reports')
appbuilder.add_view(
    DisciplineTimeChartView(),
    'Discipline Time Chart',
    icon='fa-dashboard',
    category='Reports')
...
appbuilder.add_view(
    ...
    category='Reports')
appbuilder.add_view(
    HearingTimeChartView(),
    'Hearing Time Chart',
    icon='fa-dashboard',
    category='Reports')

appbuilder.add_view(
    PrisoncommitalChartView(),
    'Prisoncommital Age Chart',
    icon='fa-dashboard',
    category='Reports')
appbuilder.add_view(
    PrisoncommitalTimeChartView(),
    'Prisoncommital Time Chart',
    icon='fa-dashboard',
    category='Reports')

appbuilder.add_view(
    CaseChartView(), 'Case Age Chart', icon='fa-dashboard', category='Reports')
appbuilder.add_view(
    CaseTimeChartView(),
    'Case Time Chart',
    icon='fa-dashboard',
