...
# Copyright (C) Nyimbi Odero, Sun Aug 13 04:38:44 EAT 2017
...
class Case(ActivityMixin, AuditMixin, Model):
    ...
    polofficer = relationship(u'Polofficer', secondary='case_polofficer', backref=u'polofficer_polofficer_cases')
    ...
    inv_supervisor_id = Column(Integer, ForeignKey('polofficer.id'))
    inv_supervisor = relationship(u'Polofficer', secondary='case_polofficer_2', backref=u'polofficer_polofficer_cases_0')
    
    polofficer2 = relationship(u'Polofficer', secondary='case_polofficer_3', backref=u'polofficer_polofficer_cases_1')
