...
class DistrictView(ModelView):#MasterDetailView, MultipleView
    datamodel=SQLAInterface(District, db.session)
    #add_title =
    #list_title =
    #edit_title =
    #show_title =
...
class RegionView(ModelView):#MasterDetailView, MultipleView
    datamodel=SQLAInterface(Region, db.session)
    #add_title =
    #list_title =
    #edit_title =
    #show_title =
