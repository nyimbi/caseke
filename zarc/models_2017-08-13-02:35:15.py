...
# Copyright (C) Nyimbi Odero, Sun Aug 13 02:35:00 EAT 2017
...
class Case(ActivityMixin, AuditMixin, Model):
    ...
    policeofficer = relationship(u'Policeofficer', secondary='case_policeofficer_2', backref=u'policeofficer_policeofficer_cases')
    policeofficer1 = relationship(u'Policeofficer', secondary='case_policeofficer_3', backref=u'policeofficer_policeofficer_cases_0')
    ...
    policeofficer2 = relationship(u'Policeofficer', secondary='case_policeofficer', backref=u'policeofficer_policeofficer_cases')
...
case_policeofficer_3 = Table(
    'case_policeofficer_3', Model.metadata, 
    Column('case', ForeignKey(u'case.id'), primary_key=True, nullable=False),
    Column('policeofficer', ForeignKey(u'policeofficer.id'), primary_key=True, nullable=False, index=True)
)
...
class Policeofficer(PersonMixin, ContactMixin,  AuditMixin, Model):
    ...
    assign_investigation = Column(ForeignKey(u'case.id'), nullable=False, index=True)

    case = relationship(u'Case', primaryjoin='Policeofficer.assign_investigation == Case.id', backref=u'policeofficers')
    ...
    parent = relationship(u'Policeofficer', remote_side=[id], primaryjoin='Policeofficer.reports_to == Policeofficer.id', backref=u'policeofficers')
