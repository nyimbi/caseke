...
from sqlalchemy import (Boolean, CheckConstraint, Column, Date, DateTime, Float,
                        ForeignKey, Integer, Numeric, String, Text, Interval)
...
ref_fieldset = [('Reference', {
    'fields': ['code', 'name', 'description', 'notes'],
    'expanded': True
})]

ref_columns = ['code', 'name', 'description']


class RefTypeMixin(object):
    # id = Column(Integer, autoincrement=True, primary_key=True)
    code = Column(String(20), unique=True, default='0000')
...
case_activity = [
    ('Activity', {
        'fields': ['action', 'activity_description', 'status']
    }),
    ('Budget', {
        'fields': ['budget', 'spend_td']
    }),
    ('Start', {
        'fields': ['planned_start', 'start_notes']
    }),
    ('End', {
        'fields': ['planned_end', 'end_notes'],
        'expanded': False
    }),
    ('Details', {
        'fields': ['task_group', 'segment', 'priority'],
        'expanded': False
    }),
    ('Tracking', {
        'fields': [
            'not_started', 'delayed_start', 'actual_start', 'actual_end',
            'delayed_end', 'completed'
        ],
        'expanded':
        False
    }),
    ('Contingency', {
        'fields': ['contingency_plan'],
        'expanded': False
    }),
]
...
class ActivityMixin(object):
    ...
    def start_delay_observer(self, actual_end, planned_end):
        self.start_delay = planned_end - actual_end
...
place_fieldset = [('Where', {
    'fields': ['place_name', 'nearest_feature', 'lat', 'lng', 'alt']
}), ('Map', {
    'fields': ['map', 'pin', 'pin_color', 'centered']
})]
...
person_docs_fieldset = [
    ('National ID', {
        'fields': ['citizenship', 'nat_id_num', 'nat_id_serial', 'nat_id_scan'],
        'expanded': False
    }),
    ('Birth Certificate', {
        'fields': ['bc_id', 'bc_number', 'bc_serial', 'bc_place', 'bc_scan'],
        'expanded': False
    }),
    ('Passport', {
        'fields': [
            'pp_no', 'pp_issue_date', 'pp_issue_place', 'pp_expiry_date',
            'pp_scan'
        ],
        'expanded':
        False
    ...
    ('Next of Kin', {
        'fields': [
            'kin1_name', 'kin1_phone', 'kin1_email', 'kin1_addr', 'kin2_name',
            'kin2_phone', 'kin2_email', 'kin2_addr'
        ],
        'expanded':
        False
    }),
...
medical_fieldset = [
    ('Medical Conditions', {
        'fields': [
            'allergies', 'chronic_conditions', 'chronic_medications', 'hbp',
            'diabetes', 'hiv', 'current_health_status'
        ],
        'expanded':
        False
    }),
]
person_fieldset = [('Picture', {
    'fields': ['photo']
}), ('Identity', {
    'fields':
    ['firstname', 'surname', 'othernames', 'gender', 'dob', 'marital_status'],
    'expanded':
    True
})]

person_show_fieldset = [('Picture', {
    'fields': ['photo_img', 'photo']
}), ('Identity', {
    'fields': [
        'firstname', 'surname', 'othernames', 'gender', 'age', 'dob',
        'marital_status'
    ],
    'expanded':
    True
...
person_biometric_fieldset = [('Biometrics', {
    'fields': [
        'fp_l1', 'fp_l2', 'fp_l3', 'fp_l4', 'fp_l5', 'fp_r1', 'fp_r2', 'fp_r3',
        'fp_r4', 'fp_r5'
    ]
}), ('Palm & Retina', {
    'fields':
    ['finger_palm_left', 'finger_palm_right', 'eye_left', 'eye_right']
})]

full_person_fieldset = person_fieldset + person_docs_fieldset + medical_fieldset + person_biometric_fieldset

person_search_exclude_columns = [
    'photo', 'photo_img', 'photo_img_thumbnail', 'fp_l1', 'fp_l2', 'fp_l3',
    'fp_l4', 'fp_l5', 'fp_r1', 'fp_r2', 'fp_r3', 'fp_r4', 'fp_r5'
] + ['finger_palm_left', 'finger_palm_right', 'eye_left', 'eye_right']

person_list_columns = ['firstname', 'surname', 'gender', 'dob']  #'_age_today'
person_exclude_columns = ['photo', 'bc_scan', 'nat_id_scan', 'pp_scan']
...
class PersonDocMixin(object):
    ...
    bc_scan = Column(
        ImageColumn(thumbnail_size=(30, 60, True), size=(300, 600, True)))
...
class PersonMixin(object):
    ...
    def _age_today(self):
        ...
        if self.dob:
            ...
            self._age_today = (
                age.days - calendar.leapdays(birthday.year, today.year)) / 365
...
biometric_fieldset = [('Bio Data', {
    'fields': [
        'eye_colour', 'hair_colour', 'complexion', 'blood_group', 'height_m',
        'weight_kg', 'striking_features', 'religion', 'ethnicity'
    ],
    'expanded':
    True
}), ('Biometrics', {
    'fields': [
        'fp_lthumb', 'fp_left2', 'fp_left3', 'fp_left4', 'fp_left5',
        'fp_rthumb', 'fp_right2', 'fp_right3', 'fp_right4', 'fp_right5'
    ],
    'expanded':
    False
}), ('Palm & Retina', {
    'fields': ['palm_left', 'palm_right', 'eye_left', 'eye_right'],
    'expanded': False
})]

biometric_columns = [
    'fp_lthumb', 'fp_left2', 'fp_left3', 'fp_left4', 'fp_left5', 'fp_rthumb',
    'fp_right2', 'fp_right3', 'fp_right4', 'fp_right5', 'palm_left',
    'palm_right', 'eye_left', 'eye_right'
]
...
class PRNMixin(object):
    ...
    def prn_id(cls):
        return Column(
            Integer, ForeignKey('humans.prn_id'), nullable=True, index=True)
...
parentage_fieldset = [('Mother', {
    'fields': [
        'm_prn', 'm_firstname', 'm_surname', 'm_othernames', 'm_nat_id_num',
        'm_education', 'm_occupation', 'm_income'
    ]
}), ('Father', {
    'fields': [
        'f_prn', 'f_firstname', 'f_surname', 'f_othernames', 'f_nat_id_num',
        'f_education', 'f_occupation', 'f_income'
    ]
})]

employment_fieldset = [
    ('Employment', {
        'fields': ['employed', 'employer', 'employer_contact']
    }),
    ('Employment Dates', {
        'fields': [
            'employ_role', 'employment_date', 'termination_date', 'supervisor',
            'supervisor_contact'
        ]
    }),
]
...
case_fieldset = [
    ('Initiation', {
        'fields': ['policestation', 'ob_number', 'report_date', 'report_notes'],
        'expanded': True
    }),
    # ('Evaluation',
...
casey_fieldset = [('Initiation', {
    'fields': ['policestation', 'ob_number', 'report_date', 'report_notes'],
    'expanded':
    False
}), ('Evaluation', {
    'fields': [
        'natureofsuit', 'policeman', 'initial_report', 'plaintiff', 'defendant',
        'observer', 'priority', 'evaluation_conclusion',
        'should_investigate_further'
    ]
}), ('Investigation', {
    'fields': [
        'investigation_assigment_date', 'policeman1',
        'investigation_assignment_note', 'investigation_plan',
        'investigation_summary'
    ]
}), ('AG Advice', {
    'fields': [
        'ag_advice_requested', 'ag_advice_req_date', 'ag_advice',
        'ag_advice_date', 'send_to_trial', 'charge_date'
    ]
}), ('Prosecution', {
    'fields': [
        'take_to_trial', 'causeofaction', 'docketnumber', 'case_name',
        'prosecutor', 'prosecution_notes', 'defense_notes', 'judgement_date',
        'judgement', 'case_closed', 'closed_date'
    ]
}), ('Sentencing', {
    'fields': [
        'fine_amount', 'sentence_length', 'sentence_startdate',
        'sentenceexpirydate', 'case_appealed', 'appeal_date', 'appeal_granted'
    ]
})]

full_contact_fieldset = [('Contact', {
    'fields': [
        'mobile', 'other_mobile', 'fixed_line', 'other_fixed_line', 'email',
        'other_email', 'address_line_1', 'address_line_2', 'zipcode', 'town',
        'country'
    ],
    'expanded':
    False
    ...
    'fields':
    ['facebook', 'twitter', 'instagram', 'whatsapp', 'other_whatsapp']
}), ('Location', {
    'fields': ['gcode', 'okhi'],
    'expanded': False
})]
...
contact_fieldset = [
    ('Contact', {
        'fields': [
            'mobile', 'fixed_line', 'email', 'address_line_1', 'address_line_2',
            'zipcode'
        ],
        'expanded':
        False
...
web_fieldset = [('Web Location', {
    'fields': [
        'full_url', 'scheme', 'domain', 'web_netloc', 'web_path', 'web_params',
        'web_query', 'web_fragment'
    ]
}), ('Hashes', {
    'fields': ['canonical_link', 'link_hash', 'content_hash']
}), ('Data', {
    'fields': ['title', 'description', 'summary', 'html', 'txt']
}), ('Metadata', {
    'fields': [
        'lang', 'tags', 'word_count', 'category_count', 'article_count',
        'link_count', 'apparent_encoding'
    ]
}), ('Publication', {
    'fields': ['author', 'publish_date', 'download_date', 'edit_date']
}), ('Admin', {
    'fields': [
        'version', 'is_downloaded', 'is_image', 'is_video', 'is_feed',
        'is_text', 'has_risk_words'
    ]
}), ('Ranking', {
    'fields': [
        'of_interest', 'ranking', 'for_review', 'is_positive', 'is_negative',
        'is_neutral', 'iterations'
    ]
}), ('Nouns', {
    'fields': ['noun_count', 'nouns']
})]
...
class WebMixin(object):
    ...
    content_hash = Column(
        String(128))  # We dont want the same content over and over
    ...
    ranking = Column(Integer,
                     CheckConstraint('(ranking >= 0) and (ranking <=10)'))
...
doc_edit_fieldset = [
    ('Data', {
        'fields': ['doctitle', 'doc', 'doc_text'],
        'expanded': True
    }),
    ('Context', {
        'fields': ['subject', 'author', 'keywords', 'comments'],
        'expanded': False
    }),
    ('Geek Stuff', {
        'fields': [
            'mime_type', 'file_size_bytes', 'char_count', 'doc_type',
            'char_count', 'word_count', 'lines', 'paragraphs', 'page_count'
        ],
        'expanded':
        False
    }),
...
doc_show_fieldset = [
    ('Data', {
        'fields': ['doctitle', 'doc_img', 'doc_text', 'play_audio'],
        'expanded': True
    }),
    ('Context', {
        'fields': ['subject', 'author', 'keywords', 'comments'],
...
audio_show_fieldset = [
    ('Data', {
        'fields': ['doctitle', 'play_audio', 'doc_text'],
        'expanded': True
    }),
    ('Context', {
        'fields': ['subject', 'author', 'keywords', 'comments'],
...
doc_columns = ['doctitle', 'subject', 'author', 'doc_type']

doc_exclude_columns = [
    'photo_img', 'photo_img_thumbnail', 'print_button', 'play_audio', 'doc',
    'doc_binary'
]
...
investigation_fieldset = [
    ('Activity', {
        'fields': [
            'investigator', 'case1', 'actiondate', 'action',
    ...
    ('Context', {
        'fields': ['weather', 'location', 'witness'],
        'expanded': True
    }),
    ('Findings', {
        'fields': ['narrative'],
    ...
    ('Evidence', {
        'fields': ['evidence_desc', 'pic1', 'pic2', 'pic3'],
        'expanded': False
    })
]
