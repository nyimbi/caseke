...
# Copyright (C) Nyimbi Odero, Sun Aug 13 02:36:25 EAT 2017
...
class Case(ActivityMixin, AuditMixin, Model):
    ...
    PoliceOfficer1 = relationship(u'PoliceOfficer', secondary='case_polofficer_2', backref=u'policeofficer_policeofficer_cases_0')
    PoliceOfficer2 = relationship(u'PoliceOfficer', secondary='case_polofficer_3', backref=u'policeofficer_policeofficer_cases')
