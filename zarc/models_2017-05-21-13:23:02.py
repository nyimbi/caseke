...
# Copyright (C) Nyimbi Odero, Sun May 21 13:13:08 EAT 2017
...
class Causeofaction(RefTypeMixin, AuditMixin, Model):
	...
	parent = relationship(u'Causeofaction', remote_side=[id],
	                      primaryjoin='Causeofaction.parent_coa == Causeofaction.id', backref=u'causeofactions')
...
class Document(DocMixin, AuditMixin, Model):
	...
	doctemplate = relationship(u'Doctemplate', primaryjoin='Document.doc_template == Doctemplate.id',
	                           backref=u'documents')
...
class Filing(AuditMixin, Model):
	...
	prosecutor = relationship(u'Prosecutor', primaryjoin='Filing.filing_prosecutor == Prosecutor.id',
	                          backref=u'filings')
...
class Hearing(ActivityMixin, AuditMixin, Model):
	...
	hearingtype = relationship(u'Hearingtype', primaryjoin='Hearing.hearing_type == Hearingtype.id',
	                           backref=u'hearings')
...
class Prisonremand(AuditMixin, Model):
	...
	defendant1 = relationship(u'Defendant', primaryjoin='Prisonremand.defendant == Defendant.id',
	                          backref=u'prisonremands')
