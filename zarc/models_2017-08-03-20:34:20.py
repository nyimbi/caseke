...
# Copyright (C) Nyimbi Odero, Thu Aug  3 20:04:30 EAT 2017
...
class District(RefTypeMixin, AuditMixin, Model):
...
class Attorney(PersonMixin, ContactMixin,  AuditMixin, Model):
    ...
    gender1 = relationship(u'Gender', primaryjoin='Attorney.gender == Gender.id', backref=u'attorneys')
...
class Case(AuditMixin, Model):
    ...
    fineamount = Column(Numeric(10,2), nullable=False)
...
class Constituency(RefTypeMixin, AuditMixin, Model):
    ...
    region1 = relationship(u'Region', primaryjoin='Constituency.region == Region.id', backref=u'constituencies')
...
class Filing(AuditMixin, Model):
    ...
    feebalance = Column(Numeric(12, 2), nullable=False)
...
class Filingtype(RefTypeMixin, AuditMixin, Model):
    ...
    perpagecost = Column(Numeric(12, 2), nullable=False)
    paid_per_page = Column(Boolean, nullable=False)
...
class Judge(AuditMixin, Model):
    ...
    gender1 = relationship(u'Gender', primaryjoin='Judge.gender == Gender.id', backref=u'judges')
...
class Observer(AuditMixin, Model):
    ...
    gender1 = relationship(u'Gender', primaryjoin='Observer.gender == Gender.id', backref=u'observers')
...
class Region(RefTypeMixin, AuditMixin, Model):
...
class Town(RefTypeMixin, AuditMixin, Model):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    district = Column(ForeignKey(u'Districts.id'), nullable=False, index=True)
