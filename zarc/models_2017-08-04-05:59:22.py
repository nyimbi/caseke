...
# Copyright (C) Nyimbi Odero, Fri Aug  4 05:13:18 EAT 2017
...
class Medevent(AuditMixin, Model):
...
class Securityrank(AuditMixin, Model):
...
class Warderrank(AuditMixin, Model):
