...
# Copyright (C) Nyimbi Odero, Sun Aug 13 05:00:53 EAT 2017
...
class Case(ActivityMixin, AuditMixin, Model):
    ...
    reported_to = Column(ForeignKey(u'PoliceOfficer.id'), index=True)

    policestation = relationship(u'Policestation', primaryjoin='Case.police_station_reported == Policestation.id', backref=u'cases')
    PoliceOfficer = relationship(u'PoliceOfficer', primaryjoin='Case.reported_to == PoliceOfficer.id', backref=u'policeofficer_policeofficer_cases')
    natureofsuit = relationship(u'Natureofsuit', secondary='case_natureofsuit', backref=u'cases')
    PoliceOfficer1 = relationship(u'PoliceOfficer', secondary='case_polofficer', backref=u'policeofficer_policeofficer_cases_0')
    PoliceOfficer2 = relationship(u'PoliceOfficer', secondary='caseinvestigation', backref=u'policeofficer_policeofficer_cases_1')
...
caseinvestigation = Table(
    ...
    Column('pol_officers', ForeignKey(u'PoliceOfficer.id'), primary_key=True, nullable=False),
