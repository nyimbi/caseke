...
# Copyright (C) Nyimbi Odero, Sat May 20 14:29:04 EAT 2017
...
class AttorneyView(ModelView):#MasterDetailView, MultipleView
	...
	#show_title =
	#base_order = ("name", "asc")
	list_exclude_columns = search_exclude_columns = person_exclude_columns + biometric_columns + person_search_exclude_columns
