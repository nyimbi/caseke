...
# Copyright (C) Nyimbi Odero, Fri May 12 14:23:03 EAT 2017
...
class Attorney(PersonMixin, ContactMixin,  AuditMixin, Model):
	...
	picture = Column(ImageColumn)
	def photo_img(self):
		im = ImageManager()
		if self.picture:
			return Markup('<a href="' + url_for('AttorneyView.show',
												pk=str(self.id)) + '" class="thumbnail"><img src="' +
						  im.get_url(self.picture) + '" alt="Photo" class="img-rounded img-responsive"></a>')
		else:
			return Markup('<a href="' + url_for('AttorneyView.show',
												pk=str(
