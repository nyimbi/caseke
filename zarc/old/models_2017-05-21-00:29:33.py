...
# Copyright (C) Nyimbi Odero, Sun May 21 00:17:31 EAT 2017
...
class Bail(AuditMixin, Model):
    ...
    amountgranted = Column(Decimal(10,2), nullable=False)
...
class Case(AuditMixin, Model):
    ...
    fineamount = Column(Decimal(10,2), nullable=False)
...
class Filing(AuditMixin, Model):
    ...
    totalfees = Column(Decimal(10,2), nullable=False)
    ...
    amountpaid = Column(Decimal(10,2), nullable=False)
    feebalance = Column(Decimal(10,2), nullable=False)
...
class Filingtype(RefTypeMixin, AuditMixin, Model):
    ...
    perpagecost = Column(Decimal(10,2), nullable=False)
