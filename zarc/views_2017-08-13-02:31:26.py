...
# Copyright (C) Nyimbi Odero, Sun Aug 13 02:00:29 EAT 2017
...
class DemotableView(ModelView):#MasterDetailView, MultipleView, CompactCRUDMixin
    datamodel=SQLAInterface(Demotable, db.session)
    #add_title =
    #list_title =
    #edit_title =
    #show_title =
...
appbuilder.add_view(DemotableView(), "Demotables", icon="fa-folder-open-o", category="Setup") 

appbuilder.add_view(DisciplineView(), "Disciplines", icon="fa-folder-open-o", category="Setup") 

appbuilder.add_view(DocarchiveView(), "Docarchives", icon="fa-folder-open-o", category="Setup") 
...
appbuilder.add_view(EventlogView(), "Eventlogs", icon="fa-folder-open-o", category="Setup") 
...
appbuilder.add_view(GateregisterView(), "Gateregisters", icon="fa-folder-open-o", category="Setup") 
...
appbuilder.add_view(PrisoncellView(), "Prisoncells", icon="fa-folder-open-o", category="Setup") 

appbuilder.add_view(PrisoncommitalView(), "Prisoncommitals", icon="fa-folder-open-o", category="Setup") 

appbuilder.add_view(PrisonerpropertyView(), "Prisonerpropertys", icon="fa-folder-open-o", category="Setup") 
...
appbuilder.add_view(RemissionView(), "Remissions", icon="fa-folder-open-o", category="Setup") 
...
appbuilder.add_view(TagView(), "Tags", icon="fa-folder-open-o", category="Setup") 
...
appbuilder.add_view(VisitorView(), "Visitors", icon="fa-folder-open-o", category="Setup") 
